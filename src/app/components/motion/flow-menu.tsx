...
const MenuItem: React.FC<MenuItemProps> = ({
    ...
    return (
        ...
        >
            <a
                className="flex items-center justify-center h-full relative cursor-pointer no-underline font-instrument-serif text-[#0C0A09] text-[2vh]"
                href={link}
                target="_blank"
                ...
                <div className="h-full flex items-center" ref={marqueeInnerRef}>
                    ...
                    >
                        {Array.from({ length: 20 }).map((_, idx) => (
                            <span
                                key={idx}
                                className="text-[#F8F8F8] font-instrument-serif font-normal text-[2vh] leading-[1.2] whitespace-nowrap flex-shrink-0 flex items-center h-full"
                            >
                                {marqueeText}
                            </span>
                        ))}
